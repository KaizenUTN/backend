...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': (
        ...
        '|-----|--------------------|\n'
        '| **Solo Lectura** | `conciliacion.view`, `reportes.view`, `dashboard.view` |\n'
        '| **Analista** | `conciliacion.run`, `conciliacion.view`, `reportes.view`, `dashboard.view` |\n'
        '| **Supervisor** | Todo lo de Analista + `conciliacion.export`, `reportes.export` |\n'
